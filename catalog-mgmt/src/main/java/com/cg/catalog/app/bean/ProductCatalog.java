...
public class ProductCatalog {
	...
	/**
	 * @param productIdParent the productIdParent to set
	 */
	...
	/**
	 * @param productIdChild the productIdChild to set
	 */
	...
	public String toString() {
		return"{\"product_id_parent\":" + "\"" + productIdParent + "\"" + ", \"product_id_child\":" + "\"" + productIdChild  + "\""
				+ ", \"price\":" + "\"" + price
				+ "\"" + "}";
}
}
